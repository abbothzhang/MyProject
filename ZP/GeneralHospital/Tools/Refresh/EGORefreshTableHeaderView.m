...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, RefreshViewHight - 40.0f, self.frame.size.width, 20.0f)];
		...
		label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, RefreshViewHight - 58.0f, self.frame.size.width, 20.0f)];
		label.autoresizingMask = UIViewAutoresizingFlexibleWidth;
		...
		layer.frame = CGRectMake(25.0f, 10, 27.0f, 50.0f);
