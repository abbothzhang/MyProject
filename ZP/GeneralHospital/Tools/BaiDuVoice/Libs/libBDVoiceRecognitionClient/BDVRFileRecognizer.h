 ...
 * @return 状态码
 */
- (id)initFileRecognizerWithFilePath:(NSString *)filePath sampleRate:(int)rate property:(TBDVoiceRecognitionProperty)property delegate:(id<MVoiceRecognitionClientDelegate>)delegate;
