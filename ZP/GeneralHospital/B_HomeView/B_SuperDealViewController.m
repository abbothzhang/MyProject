...
@interface B_SuperDealViewController () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITableViewDataSource,UITableViewDelegate>
...
@implementation B_SuperDealViewController
@synthesize ShopId;
@synthesize Type;
@synthesize CatId;
...
//    NSLog(@"dic     %@", dic);
    ...
    if (IsLine) {
        ...
        UIButton  *iconImage=[[UIButton alloc] initWithFrame:CGRectMake(10, 10, 96, 96)];
        [cell.contentView addSubview:iconImage];

        UIImageView *btnImage = [[UIImageView alloc] initWithFrame:iconImage.bounds];
        [btnImage sd_setImageWithURL:[NSURL URLWithString:[[self.dictArray ObjectAtIndex:row] ObjectForKey:@"imageurl" ]]];
        [iconImage addSubview:btnImage];
        [btnImage addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(showImage:)]];
