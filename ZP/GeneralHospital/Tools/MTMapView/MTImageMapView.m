...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [array addObject:[NSString stringWithFormat:@"%.1f", touchPoint.x ]];
    [array addObject:[NSString stringWithFormat:@"%.1f", touchPoint.y ]];
    ...
    NSLog(@"%.1f,%.1f",touchPoint.x,touchPoint.y);
    // perform new one
    [self
