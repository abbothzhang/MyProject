...
@interface D_AddAddressViewController ()

@end

@implementation D_AddAddressViewController
...
-(void)saveAct
{
    ...
    ASINetRequest* NetRequest=[ASINetRequest requestWithURL:[NSURL URLWithString:@"http://app.zipn.cn/app/receiver/save.jhtml"]];
    [NetRequest setASIPostDict:[NSDictionary dictionaryWithObjectsAndKeys:
                                ...
                                [[SecondArray objectAtIndex:CityIndex] ObjectForKey:@"id"],@"areaId",
    ...
    for (int i=0; i<[array count]; i++) {
        ...
        switch (i) {
            ...
            default:
            {
                ...
                TextField.placeholder=[[array objectAtIndex:i] objectAtIndex:1];
