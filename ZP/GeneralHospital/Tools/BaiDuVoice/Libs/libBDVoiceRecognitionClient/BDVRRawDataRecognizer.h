...
@property (nonatomic) TBDVoiceRecognitionProperty property;
 ...
 * @param property 识别模式
 */
- (id)initRecognizerWithSampleRate:(int)rate property:(TBDVoiceRecognitionProperty)property delegate:(id<MVoiceRecognitionClientDelegate>)delegate;
