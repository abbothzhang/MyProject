...
@interface MirrorMulticastDelegate ()
{
...
@interface MirrorMulticastDelegateEnumerator (PrivateAPI)
...
@implementation MirrorMulticastDelegate
...
{
	if (delegate == nil || [self checkExist:delegate]) {
        return;	    
    }   
...
{
	return [[[MirrorMulticastDelegateEnumerator alloc] initWithDelegateList:delegateList] autorelease];
}
...
@implementation MirrorMulticastDelegateEnumerator
