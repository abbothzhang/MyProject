...
- (void)showImage
{
    if (_photo.firstShow) { // 首次显示
        ...
        if ([_photo.srcImageView isKindOfClass:[UIButton class]]) {
            [((UIButton *)_photo.srcImageView) setImage:nil forState:UIControlStateNormal];
        }else
        {
...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        if ([_photo.srcImageView isKindOfClass:[UIButton class]]) {
            ...
            [_imageView sd_setImageWithURL:_photo.url placeholderImage:((UIButton *)_photo.srcImageView).currentImage options:SDWebImageRetryFailed|SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize) {
    ...
    if (_photo.firstShow) { // 第一次显示的图片
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            if ([_photo.srcImageView isKindOfClass:[UIButton class]]) {
                ...
                [((UIButton *)_photo.srcImageView) setImage:_photo.placeholder forState:UIControlStateNormal];
